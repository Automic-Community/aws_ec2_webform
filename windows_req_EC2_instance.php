...
<title>Windows Server Request</title>
...
<body id="main_body" >
	...
	<table class="header">
		...
		<td style="text-align:left;width:125px;padding-right:50px;"><img src="images/Windows_server_logo.jpg" width="100px"/></td>
		<td style="text-align:left;width:100%;"><p>Windows Server</p></td>
		</tr>
	</table>
	<div id="form_container">
		<form name="myForm" class="appnitro"  method="post" action="aws_submit_windows.php" onsubmit="return validateForm();">				
		<ul>
		<li>
		...
		<table border="0" cellspacing="0" cellpadding="2">
			...
			<tr>
				<td rowspan="4" style="text-align:left;padding-top:70px;">
					<label for="formSubmit">
					<input id="formSubmit" class="button_text" type="submit" name="formSubmit" value="Submit" />
					</label>
				</td>
			</tr>
		</table>	
